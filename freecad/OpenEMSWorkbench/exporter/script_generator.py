...
def _coax_tem_field_lines(
    ...
    *,
    ...
    if axis == "z":
        ...
        lines.append(f"    '((x-({center[0]}))/((((x-({center[0]}))*(x-({center[0]}))) + ((y-({center[1]}))*(y-({center[1]}))))*{ln_ba_value}))',")
        lines.append(f"    '((y-({center[1]}))/((((x-({center[0]}))*(x-({center[0]}))) + ((y-({center[1]}))*(y-({center[1]}))))*{ln_ba_value}))',")
        lines.append("    '0',")
        lines.append("]")
        lines.append(f"{fn_prefix}_H_expr = [")
        lines.append(f"    '(-{sign}*(y-({center[1]}))/(({two_pi}*{z0})*(((x-({center[0]}))*(x-({center[0]}))) + ((y-({center[1]}))*(y-({center[1]}))))))',")
        lines.append(f"    '({sign}*(x-({center[0]}))/(({two_pi}*{z0})*(((x-({center[0]}))*(x-({center[0]}))) + ((y-({center[1]}))*(y-({center[1]}))))))',")
        lines.append("    '0',")
        lines.append("]")
    elif axis == "x":
        lines.append(f"{fn_prefix}_E_expr = [")
        lines.append("    '0',")
        lines.append(f"    '((y-({center[1]}))/((((y-({center[1]}))*(y-({center[1]}))) + ((z-({center[2]}))*(z-({center[2]}))))*{ln_ba_value}))',")
        lines.append(f"    '((z-({center[2]}))/((((y-({center[1]}))*(y-({center[1]}))) + ((z-({center[2]}))*(z-({center[2]}))))*{ln_ba_value}))',")
        lines.append("]")
        lines.append(f"{fn_prefix}_H_expr = [")
        lines.append("    '0',")
        lines.append(f"    '(-{sign}*(z-({center[2]}))/(({two_pi}*{z0})*(((y-({center[1]}))*(y-({center[1]}))) + ((z-({center[2]}))*(z-({center[2]}))))))',")
        lines.append(f"    '({sign}*(y-({center[1]}))/(({two_pi}*{z0})*(((y-({center[1]}))*(y-({center[1]}))) + ((z-({center[2]}))*(z-({center[2]}))))))',")
        lines.append("]")
    else:
        lines.append(f"{fn_prefix}_E_expr = [")
        lines.append(f"    '((x-({center[0]}))/((((x-({center[0]}))*(x-({center[0]}))) + ((z-({center[2]}))*(z-({center[2]}))))*{ln_ba_value}))',")
        lines.append("    '0',")
        lines.append(f"    '((z-({center[2]}))/((((x-({center[0]}))*(x-({center[0]}))) + ((z-({center[2]}))*(z-({center[2]}))))*{ln_ba_value}))',")
        lines.append("]")
        lines.append(f"{fn_prefix}_H_expr = [")
        lines.append(f"    '({sign}*(z-({center[2]}))/(({two_pi}*{z0})*(((x-({center[0]}))*(x-({center[0]}))) + ((z-({center[2]}))*(z-({center[2]}))))))',")
        lines.append("    '0',")
        lines.append(f"    '(-{sign}*(x-({center[0]}))/(({two_pi}*{z0})*(((x-({center[0]}))*(x-({center[0]}))) + ((z-({center[2]}))*(z-({center[2]}))))))',")
        lines.append("]")
    lines.append("")
